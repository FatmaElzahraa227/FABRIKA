...
router.post("/sendEventReq/:sent_by", multerFun('generalimages').fields([{name: 'Images', maxCount: 10},{name: 'numPlates', maxCount: 2},{name: 'VIN', maxCount: 2},{name: 'walkaround', maxCount: 2}]),  sendEventReq);
